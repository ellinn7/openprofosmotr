...
$this->keep_table_proportions = false; //sii31924	// If table width set > page width, force resizing but keep relative sizes
...
$this->useFixedNormalLineHeight = true;	// Use the fixed factor ($this->normalLineheight) when line-height:normal
							// Compatible with mPDF versions < 6

$this->useFixedTextBaseline = true;	// Use a fixed ratio ($this->baselineC) to set the text baseline
							// Compatible with mPDF versions < 6
...
$this->SHYlang = "ru"; // Should be one of: 'en','de','es','fi','fr','it','nl','pl','ru','sv'
$this->SHYleftmin = 2;
$this->SHYrightmin = 2;
$this->SHYcharmin = 2;
$this->SHYcharmax = 10;
...
$this->list_indent_first_level = 1;		// 1/0 yes/no to indent first level of list, if using mPDF custom method
...
$this->defaultCSS = array(
	'BODY' => array(
                //'FONT-FAMILY' => 'Times New Roman', //sii31924
                'FONT-FAMILY' => 'comic',
		'FONT-SIZE' => '16.6667px', //sii31924
